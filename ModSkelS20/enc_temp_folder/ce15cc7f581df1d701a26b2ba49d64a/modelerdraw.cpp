...
void drawStar(float size) {
    ...
    GLfloat vertices[] = {
        ...
        -0.15f, 0.15f, 0.0f,  // Top-left vertex
        -0.5f, 0.15f, 0.0f,   // Left vertex
        -0.2f, -0.15f, 0.0f,  // Bottom-left vertex
        -0.35f, -0.5f, 0.0f,  // Bottom vertex

        0.0f, -0.25f, 0.0f,   // Bottom-middle vertex

        0.35f, -0.5f, 0.0f,   // Bottom vertex
        0.2f, -0.15f, 0.0f,   // Bottom-right vertex
        0.5f, 0.15f, 0.0f,    // Right vertex
        0.15f, 0.15f, 0.0f    // Top-right vertex
    };
    // Render the star

    for (int i = 0; i < 9; i += 2) {

        drawTriangle(vertices[0] * size, vertices[1] * size, vertices[2] * size,
            vertices[i + 1] * size, vertices[i + 2] * size, vertices[i + 3] * size,
            vertices[i + 3] * size, vertices[i + 4] * size, vertices[i + 5] * size);

        drawTriangle(vertices[0] * size, vertices[1] * size, vertices[2] * size,
            vertices[i + 3] * size, vertices[i + 4] * size, vertices[i + 5] * size,
            vertices[i + 5] * size, vertices[i + 6] * size, vertices[i + 7] * size);
