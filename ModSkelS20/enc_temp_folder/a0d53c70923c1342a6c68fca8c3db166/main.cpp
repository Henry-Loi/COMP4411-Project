...
int main() {
  ...
  controls[LEFTSIDELEG_LENGTH] = ModelerControl("Left Side Leg Length", 2, 3.5, 0.1f, 3.5);
  controls[RIGHTSIDELEG_LENGTH] = ModelerControl("Right Side Leg Length", 2, 3.5, 0.1f, 3.5);
