...
void drawComplexShape() {
    ...
    const float gridSize = 10.0; // Size of the grid in both x and y directions
    ...
    for (int i = 0; i < numGridPoints - 1; i++) {
        for (int j = 0; j < numGridPoints - 1; j++) {
            ...
            float z1 = cos(sqrt(x1 * x1 + y1 * y1)) - (1.0 / 5.0) * sqrt(x1 * x1 + y1 * y1);
            float z2 = cos(sqrt(x2 * x2 + y1 * y1)) - (1.0 / 5.0) * sqrt(x2 * x2 + y1 * y1);
            float z3 = cos(sqrt(x1 * x1 + y2 * y2)) - (1.0 / 5.0) * sqrt(x1 * x1 + y2 * y2);
            float z4 = cos(sqrt(x2 * x2 + y2 * y2)) - (1.0 / 5.0) * sqrt(x2 * x2 + y2 * y2);
