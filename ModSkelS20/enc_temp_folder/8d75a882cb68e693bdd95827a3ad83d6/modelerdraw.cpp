...
void drawStar(float size) {
    ...
    GLfloat vertices[] = {
        0.0f, 0.4f, 0.0f,     // Top vertex

        -0.1f, 0.1f, 0.0f,    // Top-left vertex
        -0.4f, 0.1f, 0.0f,    // Left vertex
        -0.15f, -0.1f, 0.0f,  // Bottom-left vertex
        -0.3f, -0.4f, 0.0f,   // Bottom vertex

        0.0f, -0.2f, 0.0f,    // Bottom-middle vertex

        0.3f, -0.4f, 0.0f,    // Bottom vertex
        0.15f, -0.1f, 0.0f,   // Bottom-right vertex
        0.4f, 0.1f, 0.0f,     // Right vertex
