...
int main() {
  ...
  controls[LEFTSIDELEG_LENGTH] = ModelerControl("Left Side Leg Length", 1.5, 3.5, 0.1, 3.5);
  controls[RIGHTSIDELEG_LENGTH] = ModelerControl("Right Side Leg Length", 1.5, 3.5, 0.1, 3.5);
