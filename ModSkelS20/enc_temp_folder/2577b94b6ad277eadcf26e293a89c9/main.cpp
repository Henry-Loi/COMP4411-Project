...
int main() {
  ...
  controls[LEFTSIDELEG_ROTATE] = ModelerControl("Left Side Leg Rotate", 2, 3.5, 0.1f, 3.5);
  controls[RIGHTSIDELEG_ROTATE] = ModelerControl("Right Side Leg Rotate", 2, 3.5, 0.1f, 3.5);
