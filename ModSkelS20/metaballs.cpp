...
void MetaBalls::setUpMetaballs() {
  ...
  metaballs[0].Init(Vec3f(0.3f, 0.4f, 0.4f), 0.5f);
  metaballs[1].Init(Vec3f(0.3f, -0.3f, 0.4f), 0.5f);
  metaballs[2].Init(Vec3f(0.3f, -1.0f, 0.0f), 0.5f);

  metaballs[3].Init(Vec3f(-0.3f, 0.4f, 0.4f), 0.5f);
  metaballs[4].Init(Vec3f(-0.3f, -0.3f, 0.4f), 0.5f);
  metaballs[5].Init(Vec3f(-0.3f, -1.0f, 0.0f), 0.5f);

  // set up back metaballs
  metaballs[6].Init(Vec3f(0.3f, 0.4f + VAL(METABALLS_STEP), -0.4f), 0.5f);
  metaballs[7].Init(Vec3f(0.3f, -0.3f + VAL(METABALLS_STEP), -0.4f), 0.5f);
  metaballs[8].Init(Vec3f(0.3f, -1.0f + VAL(METABALLS_STEP), -0.0f), 0.5f);

  metaballs[9].Init(Vec3f(-0.3f, 0.4f + VAL(METABALLS_STEP), -0.4f), 0.5f);
  metaballs[10].Init(Vec3f(-0.3f, -0.3f + VAL(METABALLS_STEP), -0.4f), 0.5f);
  metaballs[11].Init(Vec3f(-0.3f, -1.0f + VAL(METABALLS_STEP), -0.0f), 0.5f);
}
...
void MetaBalls::draw() { cubeGrid.DrawSurface(VAL(METABALLS_THRESHOLD)); }
