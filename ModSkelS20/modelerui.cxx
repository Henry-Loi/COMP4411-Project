...
inline void ModelerUserInterface::cb_Save1_i(Fl_Menu_ *, void *) {
  ...
  if (filename) {
    ...
    glReadPixels(0, 0, w, h, GL_RGB, GL_UNSIGNED_BYTE, imageBuffer);
...
// The first line of the file contains the values for the position/orientation
// of the camera. The values are ordered as the following:
...
inline void ModelerUserInterface::cb_SavePos_i(Fl_Menu_ *, void *) {
  ...
  if (filename) {
    ...
    fprintf(m_posFile, "%f %f %f %f %f %f %f\n", elevation, azimuth, dolly,
            twist, lookAt[0], lookAt[1], lookAt[2]);
...
Fl_Menu_Item ModelerUserInterface::menu_m_controlsMenuBar[] = {
    ...
    {"Save Raytracer File", 0, (Fl_Callback *)ModelerUserInterface::cb_Save, 0,
     0, 0, 0, 14, 0},
    {"Save Bitmap File", 0, (Fl_Callback *)ModelerUserInterface::cb_Save1, 0,
     128, 0, 0, 14, 0},
    {"Open Position File", 0, (Fl_Callback *)ModelerUserInterface::cb_OpenPos,
     0, 0, 0, 0, 14, 0},
    {"Save Position File", 0, (Fl_Callback *)ModelerUserInterface::cb_SavePos,
     0, 128, 0, 0, 14, 0},
    {"Exit", 0, (Fl_Callback *)ModelerUserInterface::cb_Exit, 0, 0, 0, 0, 14,
     0},
    {0},
    {"View", 0, 0, 0, 64, 0, 0, 14, 0},
    {"Normal", 0, (Fl_Callback *)ModelerUserInterface::cb_Normal, 0, 12, 0, 0,
     14, 0},
    {"Flat Shaded", 0, (Fl_Callback *)ModelerUserInterface::cb_Flat, 0, 8, 0, 0,
     14, 0},
    {"Wireframe", 0, (Fl_Callback *)ModelerUserInterface::cb_Wireframe, 0, 136,
     0, 0, 14, 0},
    {"High Quality", 0, (Fl_Callback *)ModelerUserInterface::cb_High, 0, 8, 0,
     0, 14, 0},
    {"Medium Quality", 0, (Fl_Callback *)ModelerUserInterface::cb_Medium, 0, 12,
     0, 0, 14, 0},
    {"Low Quality", 0, (Fl_Callback *)ModelerUserInterface::cb_Low, 0, 8, 0, 0,
     14, 0},
    {"Poor Quality", 0, (Fl_Callback *)ModelerUserInterface::cb_Poor, 0, 136, 0,
     0, 14, 0},
...
ModelerUserInterface::ModelerUserInterface() {
  Fl_Window *w;
  {
    Fl_Window *o = m_controlsWindow =
        new Fl_Window(395, 326, "CS 341 Modeler (SP02)");
    w = o;
    ...
    {
      Fl_Browser *o = m_controlsBrowser =
          new Fl_Browser(0, 25, 140, 300, "Controls");
      o->type(3);
      o->textsize(10);
  ...
  }
  {
    ...
    o->when(FL_WHEN_NEVER);
    {
      ModelerView *o = m_modelerView =
          new ModelerView(0, 0, 340, 295, "ModelerView");
      Fl_Group::current()->resizable(o);
    }
    o->end();
  }
